...
- final_proj_zhang.ipynb Andy's notebook for the final
...
- **pset2 experiments**: This folder contains all scripts used to conduct experiments for group problem set 2. Experiments include:
  ...
  - "KMeans entropy characterizer" optimization script that uses various values of d and k to find the cluster entropy for the aisles the products come from
